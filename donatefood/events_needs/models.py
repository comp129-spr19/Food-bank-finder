...
class FoodBankEvent(models.Model):
    food_bank_name = models.CharField(max_length=100, default = 'Food Bank Name', blank=False)
    food_bank_event = models.CharField(max_length=100, blank=False)
    food_bank_date = models.DateTimeField('Event Date', blank=False)
    food_bank_description = models.TextField(blank=False)
